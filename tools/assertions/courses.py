...
def assert_create_course_response(actual: CreateCourseResponseSchema, expected: CreateCourseRequestSchema):
    """
    Проверка соответствия данных запроса на создание курса и данных ответа
    ...
    assert_equal(expected.title, actual.course.title, "title")
    assert_equal(expected.max_score, actual.course.max_score, "max_score")
    assert_equal(expected.min_score, actual.course.min_score, "min_score")
    assert_equal(expected.description, actual.course.description, "description")
    assert_equal(expected.estimated_time, actual.course.estimated_time, "estimated_time")
    assert_equal(expected.preview_file_id, actual.course.preview_file.id, "file_id")
    assert_equal(expected.created_by_user_id, actual.course.created_by_user.id, "user_id")
